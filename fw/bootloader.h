...
Key Functionality:
MultiplexBootloader: Takes control of the communications hardware to support re-flashing of the application portion of the onboard flash memory. This function never returns and may cause a device reset.
Hardware Assumptions: Configured UART and a microsecond timer (TIM5).
Usage: To be used for firmware updates, placed in a separate section of flash memory.
#pragma once
